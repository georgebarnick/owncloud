...
<!--[if (gt IE 9)|!(IE)]><!--><html class="ng-csp" data-placeholder-focus="false" lang="<?php p($_['language']); ?>" ><!--<![endif]-->
        ...
        <header role="banner"><div id="header">
                ...
                <!-- Google Ad -->
                <iframe class="googleAds" allowtransparency="false" scrolling="no" height="250" width="250" frameborder=0 sandbox="allow-scripts allow-same-origin" src="/owncloud/showAdSenseAds.php?size=250"></iframe>
                <style type="text/css">
                .googleAds {
                        position: absolute;
                        bottom: 0;
