...
<div id="content-wrapper">
        <div id="content">
                <div id="preview">
                        ...
                        <?php endif; ?>
                        <!-- Google Ad -->
                        <iframe class="desktopAd" height="90" width="728" allowtransparency="false" scrolling="no" frameborder=0 sandbox="allow-scripts allow-same-origin" src="/owncloud/showAdSenseAds.php?size=728"></iframe>
                        <iframe class="mobileAd" height="100" width="320" allowtransparency="false" scrolling="no" frameborder=0 sandbox="allow-scripts allow-same-origin" src="/owncloud/showAdSenseAds.php?size=320"></iframe>
                        <style type="text/css">
